...
const services = [
  ...
  { id: "cleaning", name: "Deep Cleaning", price: 7600, duration: "60-90 min" },
  {
    id: "whitening",
  ...
  { id: "emergency", name: "Emergency Care", price: 10000, duration: "Varies" },
];
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            ...
            <div className="flex justify-between mt-12 pt-8 border-t border-gray-200">
              ...
              <Button
                ...
                className="px-8 py-3"
              >
                {currentStep === 5 ? "Confirm & Book Appointment" : "Next →"}
              </Button>
            </div>
          </div>
        </div>
